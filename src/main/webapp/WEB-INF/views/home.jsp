    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras
                ...
                condimentum nibh.</p>
            <p><a class="btn btn-default" href="<spring:url value="/productList/${'Games'}"/>" role="button">View details &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
            <img class="img-circle"
                 src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=="
            ...
            <p><a class="btn btn-default" href="<spring:url value="/productList/${'Software'}"/>" role="button">View details &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
    </div><!-- /.row -->
